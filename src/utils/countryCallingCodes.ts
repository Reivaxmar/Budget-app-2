...
// All ITU-assigned country calling codes. Some codes are shared by several
// countries/territories (e.g. +1 for the US/Canada/Caribbean, +7 for
// Russia/Kazakhstan) — each still gets its own row since the *country* is
// what the user is picking, not just the numeric prefix.
